...
class MainMenuView(View):
    def __init__(self, core):
        ...
        start_button = DirectButton(text="Start expoloring", command=core.comm(), pos=(0, 0, -0.2), parent=self.screen, scale=0.1)
        start_button.setTransparency(True)
        map_button = DirectButton(text="Go to the map", pos=(0, 0, -0.4), parent=self.screen, scale=0.1)
        #map_button.setTransparency(True)
        quit_button = DirectButton(text="Quit", pos=(0, 0, -0.6), parent=self.screen, scale=0.1)
