...
class PauseMenuView(View):
    def __init__(self, core):
        ...
        continue_button = DirectButton(text="Continue", command=core.change_for_scene_3d_view, pos=(0, 0, -0.2), parent=self.screen, scale=0.1)
        quit_button = DirectButton(text="Quit", command=quit, pos=(0, 0, -0.4), parent=self.screen, scale=0.1)
        self.screen.hide()